import {logoutUser, authenticate, postTweet, getAllTweets, getOneTweet, getUserTweets, deleteOneTweet, searchTweets} from '@src/requests'

$(".static_pages.feed").ready(function(){

    console.log('Hello from feeds');
    ...
    authenticate(function(response) {
      ...
      if(response.authenticated) {
        ...
        //$('.user-name p').text(currentUser);
        //$('.user-screen-name').text('@'+currentUser);
        getUserTweets(currentUser, function(response) {
          $('#yourTotal').text(response.length);
        });
      } else {
